#This code aims to split and process a collection of
#.xz compressed files, create split output files, and generate a
# vocabulary file containing the unique characters found in the 
#processed data.
